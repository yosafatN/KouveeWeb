    ...
    <v-data-iterator :items="books" :search="search" hide-default-footer >
      <template v-slot:header>
        <v-toolbar class="mb-2" color="white" flat >
          <v-toolbar-title>Book Review</v-toolbar-title>
                ...
                <v-card>
                    ...
                    <v-list dense>
                        ...
                        <v-list-item>
                            ...
                            <v-list-item-content class="align-end">: {{ item.review }}</v-list-item-content>
                        </v-list-item>
                        <v-list-item>
                            <v-list-item-content>Rating</v-list-item-content>
                            <v-list-item-content class="align-end">: {{ item.rating }}/5</v-list-item-content>
                        </v-list-item>
                    </v-list>
                    ...
                    <v-card-actions>
                        <v-btn color="blue" dark @click="editHandler(item)">Edit</v-btn>
                        <v-btn color="red" dark @click="deleteData(item)">Delete</v-btn>
                    </v-card-actions>
                    ...
                    <v-dialog v-model="dialog" persistent max-width="600px">
                        <v-card>
                            ...
                            <v-card-text>
                                <v-container>
                                    <v-row>
                                        ...
                                        <v-col cols="12">
                                            <v-text-field label="Rating*" v-model="form.rating" required></v-text-field>
                                        </v-col>
                                    </v-row>
                                </v-container>
                            ...
                            <v-card-actions>
                                ...
                                <v-btn color="blue darken-1" text @click="updateData(item.id)">Save</v-btn>
                            </v-card-actions>
                        </v-card>
                    </v-dialog> 
                </v-card>
...
export default {
        ...
        methods: {
            ...
            deleteData(item) {
                var uri = this.$apiUrl + '/review/' + item.id; //data dihapus berdasarkan id_wish
            ...
            updateData(){             
                ...
                var uri = this.$apiUrl + '/review/' + this.id;             
                this.load = true             
