            ...
            <v-container grid-list-md mb-0>
                ...
                <v-layout row wrap style="margin:10px">
                    ...
                    <v-flex xs6 class="text-right">
                        ...
                        <v-select class="align-center" :items="jenis_layanan_nama" v-model="filter" label="Sort Kategori Layanan" outlined clearable="true"></v-select>
                    </v-flex>
                    </v-flex>
                    <v-flex xs6 class="text-right">
...
export default {
    ...
    computed:{
        filteredItems() {
            ...
            var x = this.reviews.filter((i) => {
                return !this.filter || (i.id_layanan === this.filter);
            })
            
            if(this.keyword.length>0) {
                return x.filter((i) => {
                return !this.keyword || (i.id_layanan.toLowerCase().includes(this.keyword.toLowerCase())) || (i.id_ukuran_hewan.toLowerCase().includes(this.keyword.toLowerCase()));
                })
            }else{
                return x;
            }
