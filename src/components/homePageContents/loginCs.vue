<template>
  <article>
    <div class="container" :class="{'sign-up-active' : signUp}">
      <div class="overlay-container">
        <div class="overlay">
          ...
          <div class="overlay-right">
            ...
            <p>Pastikan Jabatan anda adalah Customer Service</p>
      ...
      <form class="sign-in">
        <h2>Customer Service Login</h2>
        <div>Silahkan Masukan Data Anda</div>
          <v-text-field type="email" placeholder="Masukan Data Customer Service anda" v-model="form.email" required></v-text-field>
