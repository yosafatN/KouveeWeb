    ...
    <div class="container" :class="{'sign-up-active' : signUp}">
      <div class="overlay-container">
        <div class="overlay">
          ...
          <div class="overlay-right">
            ...
            <h3>Kasir Platform</h3>
            <p>Pastikan Jabatan anda adalah Kasir</p>
      ...
      <form class="sign-in">
        ...
        <div>Silahkan Masukan Data Anda</div>
          <v-text-field type="email" placeholder="Masukan Data Kasir anda" v-model="form.email" required></v-text-field>
