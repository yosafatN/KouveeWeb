                ...
                <v-row>
                    <v-col v-for="(item, index) in produks" :key="index" cols="12" sm="6" md="4" lg="3">
                        <v-card class="mx-auto" max-width="400" @click="pilih(item)">
                            <v-img v-if="item.link_gambar !== null" class="white--text align-end" height="200px" :src="item.link_gambar"></v-img>
...
export default {
    ...
    methods: {
        ...
        tambah() {
            this.$router.push('/Admin/transaksi/penjualan')
        },
        ...
        tambahDetail() {
            ...
            this.request.append('pegawai', this.pegawi);
