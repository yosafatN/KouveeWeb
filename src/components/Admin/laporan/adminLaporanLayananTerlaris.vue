            ...
            <v-card>
                <v-card-text>
                    ...
                    <v-card-actions>
                        ...
                        <v-btn color="blue darken-1" text @click="pdf()">Pilih</v-btn>
                    </v-card-actions>
                </v-card-text>
            </v-card>
        </v-dialog>
...
export default {    
    ...
    methods:{         
        ...
        pdf(){
            var link_laporan= 'http://localhost/KouveePetshop/index.php/Laporan/LayananTerlaris?tahun='+this.dropdown;
