    ...
    <v-container>
        <v-card>
            <v-container grid-list-md mb-0>
                <h2 class="text-md-center">Pengadaan Produk Bulanan</h2>
                <v-layout row wrap style="margin:10px">
                    <v-flex xs6>
                        ...
                        <v-btn depressed rounded style="text-transform: none !important;" color="red accent-3"
                            ...
                            Print Pengadaan Produk Bulanan
                        </v-btn>
                    </v-flex>
...
export default {    
    ...
    methods:{         
        ...
        pdf(){
            var link_nota= 'http://localhost/KouveePetShop/index.php/Laporan/PengadaanProdukBulanan?tahun=2020&bulan=3';
