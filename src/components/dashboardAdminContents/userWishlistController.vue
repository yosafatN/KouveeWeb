                    ...
                    <v-container>
                        <v-row>
                            <v-col cols="12">
                                ...
                                <v-text-field label="tanggal_lahir" v-model="form.tanggal_lahir" required></v-text-field>
                                ...
                                <v-text-field label="id_role_pegawai" v-model="form.id_role_pegawai" required></v-text-field>
                            </v-col>
                        </v-row>
...
export default {    
    ...
    methods:{         
        ...
        sendData(){             
            ...
            this.request.append('id_role_pegawai', this.form.id_role_pegawai);   
