    ...
    <v-container>
        <v-card>
            <v-container grid-list-md mb-0>
                <h2 class="text-md-center">Transaksi Produk Kouvee Kasir</h2>
                <v-card flat>
                    <v-col cols="12" sm="3">
...
export default {    
    ...
    methods:{         
        ...
        deleteData(deleteId){ //mengahapus data
            var uri = this.$apiUrl + '/TransaksiPenjualan/delete/' + deleteId; //data dihapus berdasarkan id 
            this.request.append('is_member', '1');
            this.request.append('id_CS', '1');
            this.request.append('no_telp', form.no_telp);
            this.request.append('updated_by', 'Ajeng9999');
            this.$http.post(uri,this.request).then(response =>{                 
                this.snackbar = true;                 
