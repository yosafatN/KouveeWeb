    ...
    <v-container>
        <v-card>
            <v-container grid-list-md mb-0>
                <h2 class="text-md-center">Pelaporan Layanan Kasir</h2>
                <v-card flat>
                    <v-col cols="12" sm="3">
                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12">
                                <v-text-field label="Status" v-model="form.status" required></v-text-field>
                            </v-col>
                        </v-row>
...
export default {    
    ...
    methods:{         
        ...
        sendData(){ 
            ...
            this.request.append('id_CS', 'Rafael66');
        ...
        updateData(){
            ...
            this.request.append('id_CS', 'Rafael66');
            this.request.append('status', this.status);
            this.request.append('is_member', '0');
        ...
        pdf(no_transaksi,diskon){
            var link_nota= 'http://localhost/KouveePetShop/index.php/NotaLayanan?no='+'LY-010320-02'+'&diskon='+'20000';
