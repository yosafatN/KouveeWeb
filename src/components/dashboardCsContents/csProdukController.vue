                    ...
                    <v-container>
                        <v-row>
                            <v-col cols="12">
                                ...
                                <v-text-field label="id_kategori_produk" v-model="form.id_kategori_produk" required></v-text-field>
                                ...
                                <v-text-field label="jmlh_min" v-model="form.jmlh_min" required></v-text-field>
                                <v-text-field label="jmlh" v-model="form.jmlh" required></v-text-field>
                            </v-col>
                        </v-row>
...
export default {    
    ...
    methods:{         
        ...
        sendData(){             
            ...
            this.request.append('id_kategori_produk', this.form.id_kategori_produk);  
